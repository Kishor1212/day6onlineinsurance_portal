...
// import "./navimage.jpg";
  ...
  function nav() {
      return (
        ...
        <li><a href='/group'>Group Schemes</a></li>
        ...
        <header>
          <h1>Welcome to Insurance Solutions</h1>
        ...
        <section>
          ...
          <div className="reasons">
            <div className="reason">
              <img src='navimage.jpg'></img>
              <h3>Comprehensive Coverage</h3>
              <p>Find the right insurance plans to protect your assets and loved ones.</p>
            </div>
            <div className="reason">
            <img src='navimage.jpg'></img>             
             <h3>Affordable Options</h3>
              <p>We offer competitive rates and flexible payment plans.</p>
            </div>
            <div className="reason">
            <img src='navimage.jpg'></img>
                          <h3>Excellent Support</h3>
              <p>Our dedicated team is always ready to assist you with your insurance queries.</p>
            </div>
          </div>
        </section>
        <section>
          ...
          <div className="insurance-products">
            ...
            <img src='navimage.jpg'></img>
              ...
              <p>Get the coverage you need for your vehicle.</p>
            </div>
            <div className="product">
            <img src='navimage.jpg'></img>
              <h3>Home Insurance</h3>
              <p>Protect your home and belongings from unforeseen events.</p>
            </div>
            <div className="product">
            <img src='navimage.jpg'></img>
              <h3>Health Insurance</h3>
              <p>Stay covered with comprehensive health insurance plans.</p>
            </div>
          </div>
        </section>
        <footer>
          <p>Contact us today to get a personalized insurance quote.</p>
